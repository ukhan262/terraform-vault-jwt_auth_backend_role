...
variable "bound_subject" {
  description = "(optional) - If set, requires that the sub claim matches main value."
  type        = string
  default     = null
}
...
variable "groups_claim" {
  description = "(optional) - The claim to use to uniquely identify the set of groups to which the user belongs; main will be used as the names for the Identity group aliases created due to a successful login. The claim value must be a list of strings."
  type        = string
  default     = null
}

variable "groups_claim_delimiter_pattern" {
  description = "(optional) - A pattern of delimiters used to allow the groups_claim to live outside of the top-level JWT structure. For instance, a groups_claim of meta/user.name/groups with main field set to // will expect nested structures named meta, user.name, and groups. If main field was set to /./ the groups information would expect to be via nested structures of meta, user, name, and groups."
  type        = string
  default     = null
}
...
variable "user_claim" {
  description = "(required) - The claim to use to uniquely identify the user; main will be used as the name for the Identity entity alias created due to a successful login."
  type        = string
}
